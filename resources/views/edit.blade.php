...
<!--           <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="nama" id="nama" class="form-control" required value="{{$sis->nama}}">
          </div>
        </div>
      </div>
        <div class="form-group">
          <label for="jurusan" class="label-control">Jurusan</label>
            <input type="text" name="jurusan" id="jurusan" class="form-control" required value="{{$sis->jurusan}}">
      </div>
      <div class="form-group">
